...
<p><span style={{color: "red"}}>Each round, irrespective of its difficulty, has the same fixed time limit for completion</span>. You have the option to choose whether or not to attempt each task. If you think that any task assigned to you is too difficult, you can skip it by just putting ‘0’.</p>
