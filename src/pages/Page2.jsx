...
export default function Page2() {
  return (
    <div>
      <h1>INSTRUCTIONS</h1>
        <p>In this experiment, you will play the role of an employee, who has been assigned tasks by his manager. <b>The tasks you will be faced with were selected for you by another participant who is playing the role of your manager.</b> He/she is aware of the difficulty or simplicity of each task before he/she assigns them to you.</p>
      <p>You will be presented with a series of lines of emojis, <b> your task as assigned by your manager is to count the number of times a certain emoji appears.</b> This will be repeated for up to 6 rounds depending on the number of tasks assigned to you by your manager. You will be able to see your progress and how many tasks you have left at the top of your screen.</p>
<p><span style={{color: "red"}}>Each question, irrespective of its difficulty, has the same fixed time limit for completion</span>. You have the option to choose whether or not to attempt each task. If you think that any task assigned to you is too difficult, you can skip it by just putting ‘0’.</p>
